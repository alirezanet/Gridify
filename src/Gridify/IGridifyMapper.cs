...
public interface IGridifyMapper<T>
{
   ...
   /// <param name="prefix">Optional prefix to prepend to nested mapping keys. If null or empty, merges mappings directly without a prefix.</param>
