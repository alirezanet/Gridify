...
namespace Gridify
{
   ...
   public static class DynamicClassFactory
   {
      ...
      private static string DynamicAssemblyName = "Gridify.DynamicClasses, Version=2.4.8.0";
      private static string DynamicModuleName = "Gridify.DynamicClasses";
      ...
      /// </code>
      /// </example>
      public static Type CreateType(IEnumerable<DynamicProperty> properties, bool createParameterCtor = true)
      {
         if (properties == null)
         {
